...
@Singleton
@Component(modules = [(RepositoryModule::class), (ScheduleDaoModule::class), (ContextModule::class), (MainActivityComponent::class), (RefreshableDailyScheduleFragmentComponent::class), (WeeklyScheduleFragmentComponent::class), (SettingsModule::class)])
