...
@OpenForTesting
class DailyScheduleDaoImpl(context: Context) : DailyScheduleDao {

    private val dailyScheduleCache: DualCache<DailySchedule> = Builder<DailySchedule>(DailyScheduleDao.DAILY_SCHEDULE_KEY, 1).enableLog()
